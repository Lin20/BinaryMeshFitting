...
typedef std::function<void(const float world_size, const glm::vec3& p, const glm::ivec3& size, const float scale, float** out, FastNoiseVectorSet* vectorset_out)> SamplerBlockFunction;
